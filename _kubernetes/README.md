...
Amazon Elastic Kubernetes Service [EKS](https://aws.amazon.com/eks/) is a service that allows users to run Kubernetes in AWS without needing to install and operate your own Kubernetes clusters.
...
6. Run history manager, notification manager and sensor manager
