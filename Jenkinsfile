    ...
    post {
        always {
            script {
                ...
                if (env.CONFIG_USE_APIURL == "richmondu.com") {
                    mail to: 'richmond.umagat@brtchip.com, sree.b@brtchip.com, srikanth.anandapu@brtchip.com, unnamalai.kanchi@brtchip.com, jawhar.pp@brtchip.com, ajith.mk@brtchip.com, sino.kd@brtchip.com, aswini.govindarajan@brtchip.com',
