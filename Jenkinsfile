        ...
        always {
            script {
                ...
                if (env.CONFIG_USE_APIURL == "richmondu.com") {
                    mail to: 'richmond.umagat@brtchip.com, iotmodem-sw@brtchip.com, khang.nguyen@brtchip.com',
                    ...
                    mail to: 'richmond.umagat@brtchip.com, iotmodem-sw@brtchip.com, khang.nguyen@brtchip.com, cynthia.zhang@brtchip.com',
                        subject: "Jenkins notification - ${currentBuild.projectName}",
                        body: "This email was generated by Jenkins server.\n\nJenkins build triggered for DEV branch (DEV version). Refer to ${env.BUILD_URL}.\nProject: ${currentBuild.projectName}\nResult: ${currentBuild.currentResult}\n\nVisit https://ec2-54-88-41-145.compute-1.amazonaws.com for the updated website!\n"
                }
