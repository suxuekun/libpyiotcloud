        ...
        always {
            script {
                ...
                if (env.CONFIG_USE_APIURL == "prod.brtchip-iotportal.com") {
                    mail to: 'richmond.umagat@brtchip.com, iotmodem-sw@brtchip.com',
                ...
                else if (env.CONFIG_USE_APIURL == "test.brtchip-iotportal.com") {
                    mail to: 'richmond.umagat@brtchip.com',
                        subject: "Jenkins notification - ${currentBuild.projectName}",
                        body: "This email was generated by Jenkins server.\n\nJenkins build triggered. Refer to ${env.BUILD_URL}.\nProject: ${currentBuild.projectName}\nEnvironment: TEST\nResult: ${currentBuild.currentResult}\n\nVisit https://test.brtchip-iotportal.com for the updated website!\n"
                }
                else {
                    mail to: 'iotmodem-sw@brtchip.com',
                        subject: "Jenkins notification - ${currentBuild.projectName}",
