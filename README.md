...
1. Webserver - Nginx (contains SSL certificate; all requests go through NGINX; forwards HTTP requests to webapp or restapi)
...
4. Messaging - RabbitMQ (device communicates directly with RabbitMQ; web/mobile apps communicates to device via RabbitMQ)
